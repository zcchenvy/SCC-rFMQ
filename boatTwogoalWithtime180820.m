function [ output1,output2, output3] = boatTwogoalWithtime180809( input1,input2 )
...
while i<100 && X<50 && Y<100 && Y>1
    ...
    ext=fc*(X/50-(X/50)^2);
    C1=min(max(C+0.01*(W+W1)/2,-pi/3+0.00001),pi/3-0.00001);
...
if X<50 && Y<100 && Y>1
    ...
    output2=-0.1;
    output3=0;
elseif X>=50 && abs(Y-30)<=5    
    output1=100000*1+1000*50+100*5+10*5+5;
    output2=15-3*abs(Y-30);
    output3=1;
elseif X>=50 && abs(Y-50)<=10    
    output1=100000*1+1000*50+100*5+10*5+5;
    output2=10-abs(Y-50);
    output3=1;
elseif X>=50 && abs(Y-80)<=20     
    output1=100000*1+1000*50+100*5+10*5+5;
    output2=10-0.5*abs(Y-80);
    output3=1;  
else
    output1=100000*1+1000*50+100*5+10*5+5;
    output2=0; 
